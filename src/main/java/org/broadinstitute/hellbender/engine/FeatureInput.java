 ...
 */
public final class FeatureInput<T extends Feature> extends GatkInputURI implements Serializable {
    ...
    FeatureInput(final String rawArgumentValue) {
        ...
        this.featureFile = this.getFeaturePath().toString();
    }
    ...
    public boolean hasUserSuppliedName() {
        return !featureFile.equals(getTag());
    }
    ...
    @Override
    public int hashCode() {
        return 31 * getTag().hashCode() + featureFile.hashCode();
    }
    ...
    public boolean equals(final Object other) {
        ...
        return getTag().equals(otherFeature.getTag()) && featureFile.equals(otherFeature.featureFile);
    }
    ...
    public String toString() {
        ...
        return getTag().equals(featureFilePath) ? featureFilePath :
